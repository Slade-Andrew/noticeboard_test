...
class Controller_View_Notices extends Controller
{
	
	public function action_index()
	{
		return Response::forge(View::forge('viewNotice/index'));
	}

/*
class Controller_View_Notices extends Controller_Notices
{
	public $template = 'template_old';
